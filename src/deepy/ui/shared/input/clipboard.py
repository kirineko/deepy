"""Cross-platform clipboard image readers for the prompt UIs.

Extracted from ``deepy.ui.shared.input.image_input`` so the attachment controller stays
focused. ``deepy.ui.shared.input.image_input`` re-exports :class:`ClipboardImage` and
:func:`clipboard_image` for backwards compatibility.
"""
