...
**Migration**: Use "Responses Image Model Set" in this capability. Reconfigure removed provider IDs and legacy formats explicitly; no old protocol fallback is retained.
